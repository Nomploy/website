---
title: Monitoring
description: "Monitor your applications and servers with Nomploy"
---
...
- **Metrics Callback URL**: The endpoint that receives metrics data. Default URL is:
  ```
  https://app.nomploy.com/api/trpc/notification.receiveNotification
  ```
...
This is feature only available on Cloud Version of Nomploy.
