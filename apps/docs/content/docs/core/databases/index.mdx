---
title: Databases
description: "Discover how to create and backup databases easily with Nomploy, supporting a variety of database systems."
---

Nomploy simplifies the process of creating and managing databases, offering robust options for both setup and backups.

## Database Support

Nomploy currently supports a range of popular database systems, ensuring compatibility and flexibility for your projects:
