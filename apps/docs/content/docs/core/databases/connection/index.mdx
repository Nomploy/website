---
title: Connection
description: "Learn how to connect to your database using Nomploy."
---

This section explains how to configure database access for applications in Nomploy, including both internal connections within your network and external connections accessible over the internet.
