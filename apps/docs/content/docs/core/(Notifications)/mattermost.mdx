...
Mattermost notifications are a great way to stay up to date with important events in your Nomploy panel. You can choose to receive notifications for specific events or all events.
...
5. Go to Nomploy `Notifications` and select `Mattermost` as the notification provider.
