---
title: Applications
description: "Explore the multiple deployment methods available in Nomploy, including GitHub, Git, Docker, and automated deployments via webhooks."
---

Applications in Nomploy are treated as a single service, entity or container, making it easy and intuitive for users to work with each application in its own workspace.
