...
Nomploy allows you to configure zero downtime deployments, which means that you can deploy your application without any downtime.
...
but Nomploy allows you to configure zero downtime deployments.
...
1. We will use this example [Github Repo](https://github.com/Nomploy/swarm-test)
2. It Have a endpoint called `health` [endpoint](https://github.com/Nomploy/swarm-test/blob/main/index.js#L20) which is the one that will tell us if our application is healthy.
...
1. **Use Git Provider in Your Application**:
   - Repository: `https://github.com/Nomploy/swarm-test`
   - Branch: `main`
   - Build path: `/`
