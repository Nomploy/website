...
description: "Use AWS Secrets Manager secrets in your Nomploy environment variables."
---
...
Create an IAM user (or use an existing one) with programmatic access and a least-privilege policy for the secrets Nomploy should reach:
	...
	"Statement": [
		{
			...
			"Resource": "arn:aws:secretsmanager:*:*:secret:nomploy/*"
		}
	]
}
```
