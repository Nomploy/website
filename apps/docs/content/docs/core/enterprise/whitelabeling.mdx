---
title: Whitelabeling
description: Rebrand Nomploy with your application name, logos, colors, and custom links
---

Whitelabeling lets Enterprise users fully rebrand their Nomploy instance. You can customize the application name, logos, favicon, appearance, metadata, links, and error pages — all from **Settings → Whitelabel**.
...
| Field | Description |
| --- | --- |
| **Application Name** | Replaces "Nomploy" across the entire interface. |
| **Application Description** | Tagline shown on the login/onboarding pages. Defaults to the standard Nomploy description if empty. |
...
| Field | Description |
| --- | --- |
| **Page Title** | Browser tab title. Defaults to "Nomploy" if empty. |
...
- **Reset to Defaults** — Revert all whitelabel settings back to the default Nomploy branding.
...
For help enabling or configuring whitelabeling, [contact us](https://nomploy.com/contact).
