...
In the free version, Nomploy provides three built-in roles: **Owner**, **Admin**, and **Member**. Members have a limited, fixed set of permissions. With Enterprise, you can create **custom roles** that combine any of the available permissions below, then assign those roles to users in your organization.
...
For help configuring custom roles, [contact us](https://nomploy.com/contact).
