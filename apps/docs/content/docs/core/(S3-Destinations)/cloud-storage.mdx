...
5. Copy the value in `Storage URI`. You will need this for the Endpoint value in Nomploy.
...
| (from) Cloud Storage | (to) Nomploy        | Example value                                                        |
|---------------------|---------------------|---------------------------------------------------------------------|
...
| `Bucket Name`       | `Bucket`            | `nomploy-backups` use the name of the bucket you created.            |
