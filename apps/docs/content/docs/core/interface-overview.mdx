...
description: 'A visual tour of the Nomploy dashboard — screenshots of every major section of the panel.'
---

This page is a visual tour of the Nomploy dashboard. Use it to get familiar with each section of the panel before diving into the feature guides. Click any image to zoom in.

## Home

The home dashboard summarizes your organization at a glance: projects, services, recent deployments and their status.

<ImageZoom src="/assets/images/ui/home.png" alt="Nomploy home dashboard with projects, services and recent deployments" width={1600} height={775} className="rounded-lg"/>
...
Domain, certificates, and maintenance actions for the Nomploy panel itself:
...
Rebrand your Nomploy instance with your own name, logos and colors:
