...
Nomploy provides seamless integration with Docker Registry repositories, allowing you to deploy applications directly from your container images. This feature is available for single applications and supports both public and private registries.
...
1. **Create Access Token**:
   ...
   - Set description: `Nomploy-Docker-Hub-Token`
   - Select **Read-only** permissions
   - Click **Generate**

2. **Configure in Nomploy**:
...
1. **Create GitHub Personal Access Token**:
   ...
   - Set token name: `Nomploy-GHCR-Token`
...
- **Registry Timeout**: Verify the registry URL is accessible from your Nomploy instance
