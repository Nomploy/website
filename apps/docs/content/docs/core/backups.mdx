---
title: Backups
description: 'Learn how to create and restore backups of your Nomploy applications and services.'
---

import { Callout } from 'fumadocs-ui/components/callout';

Nomploy provides a comprehensive backup and restore system that saves your entire Nomploy file system and database to ensure your data is safe and recoverable.
...
When a backup is created, Nomploy will:
- Back up the PostgreSQL database (`nomploy-postgres`)
- Save the Nomploy file system (`/etc/nomploy`)
...
During restoration, Nomploy will:
- Clear the existing `/etc/nomploy` directory and replace it with the backup contents
- Drop the existing `nomploy-postgres` database
