---
title: Multi-Tenancy
description: "Understand how Nomploy organizes resources using Organizations, Projects, Environments, and Services for team collaboration and resource isolation."
---

import { Callout } from 'fumadocs-ui/components/callout';

Nomploy provides a hierarchical multi-tenancy model that lets you organize your infrastructure cleanly — whether you're a solo developer or managing multiple teams. This guide explains how Organizations, Projects, Environments, and Services work together.

## Resource Hierarchy

Nomploy organizes all resources in a four-level hierarchy:
...
The **Organization** is the top-level container in Nomploy. Everything — users, projects, servers, settings — belongs to an organization.

- Each Nomploy instance starts with **one default organization** created during setup.
- The user who installs Nomploy becomes the **Owner** of that organization.
...
**Services** are the actual workloads running inside an environment. Nomploy supports three types of services:
...
Nomploy's permission system maps directly to this hierarchy, allowing you to control who can see and do what at every level.
