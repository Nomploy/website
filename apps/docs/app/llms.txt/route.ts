...
const baseUrl = "https://docs.nomploy.com";
...
export function GET() {
	...
	const lines = [
		...
		"",
		"> Nomploy is an open-source, self-hostable Platform as a Service (PaaS) that simplifies the deployment and management of applications, databases, and services.",
		"",
		"## Docs",
		"",
		...docsPages.map(
