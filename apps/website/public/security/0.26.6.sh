...
# Configures secure database credentials for Nomploy installations
...
if docker secret ls 2>/dev/null | grep -q "nomploy_postgres_password"; then
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Nomploy Security Configuration"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "👋 Hey! I noticed your Nomploy installation doesn't have"
...
echo "$NEW_PASSWORD" | docker secret create nomploy_postgres_password - 2>/dev/null

echo "✅ Credentials saved securely in Docker Secrets (encrypted)"

# Update PostgreSQL password
echo "🔄 Updating database..."
POSTGRES_CONTAINER=$(docker ps --filter "name=nomploy-postgres" --format "{{.ID}}" | head -n1)

if [ -n "$POSTGRES_CONTAINER" ]; then
    docker exec \
      -e PGPASSWORD=amukds4wi9001583845717ad2 \
      "$POSTGRES_CONTAINER" \
      psql -U nomploy -d nomploy \
      -c "ALTER USER nomploy WITH PASSWORD '${NEW_PASSWORD}';"
fi
...
docker service update \
    ...
    --secret-add source=nomploy_postgres_password,target=/run/secrets/postgres_password \
    --env-add POSTGRES_PASSWORD_FILE=/run/secrets/postgres_password \
    nomploy-postgres

# Update Nomploy service to use Docker Secret
...
echo "   • Nomploy service updated to use secrets"
echo ""
...
echo ""
echo "💡 Next steps:"
echo "   • Your Nomploy should be accessible shortly"
