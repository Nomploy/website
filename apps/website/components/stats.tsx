...
function getGrid({
	...
	return [
		{
			title: "GitHub Stars",
			description: `With over ${(githubStars / 1000).toFixed(1)}k stars on GitHub, Nomploy is trusted by developers worldwide. Explore our repositories and join our community!`,
			icon: (
		...
		},
		{
			...
			description: `Thanks to our growing base of over ${contributors} contributors, Nomploy continues to thrive, with valuable contributions from developers around the world.`,
