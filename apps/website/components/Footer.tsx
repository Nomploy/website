		...
		links: [
			{
				...
				label: "Nomploy vs. Coolify",
			},
			{
				href: "/nomploy-vs-portainer",
				label: "Nomploy vs. Portainer",
			},
			{
				href: "/nomploy-vs-caprover",
				label: "Nomploy vs. CapRover",
			},
			{
				href: "/nomploy-vs-dokku",
				label: "Nomploy vs. Dokku",
			},
			{
				href: "/nomploy-vs-render",
				label: "Nomploy vs. Render",
			},
			{
			...
			<Container>
				...
				<div className="flex flex-col items-center border-t border-slate-400/10 py-8 sm:flex-row sm:justify-between sm:items-center gap-6">
					<p className="text-sm text-muted-foreground order-2 sm:order-1">
						© {new Date().getFullYear()} Nomploy. All rights reserved.
					</p>
					<div
					...
					>
						<Link
							...
							aria-label="Nomploy on X (Twitter)"
						>
							<svg
								stroke="currentColor"
								fill="currentColor"
