...
const reviews = [
	...
	},
	{
		name: "apis",
		username: "@apis",
		body: "I replaced my previous setup with Nomploy today. It’s stable, easy to use, and offers excellent support!",
		img: "https://avatar.vercel.sh/apis",
	},
	{
		name: "yayza_",
		username: "@yayza_",
		body: "Migrated all my services to Nomploy—it worked seamlessly! The level of configuration is perfect for all kinds of projects.",
		img: "https://avatar.vercel.sh/yayza",
	},
	{
		name: "Vaurion",
		username: "@vaurion",
		body: "Nomploy makes my deployments incredibly easy. I just test locally, push a preview to GitHub, and Nomploy takes care of the rest.",
		img: "https://avatar.vercel.sh/vaurion",
	},
	{
		name: "vinum?",
		username: "@vinum",
		body: "Nomploy is everything I wanted in a PaaS. The functionality is impressive, and it's completely free!",
		img: "https://avatar.vercel.sh/vinum",
	},
	{
		name: "vadzim",
		username: "@vadzim",
		body: "Nomploy is fantastic! I rarely encounter any deployment issues, and the community support is top-notch.",
		img: "https://avatar.vercel.sh/vadzim",
	},
	{
		name: "Slurpy Beckerman",
		username: "@slurpy",
		body: "This is exactly what I want in a deployment system. I’ve restructured my dev process around Nomploy!",
		img: "https://avatar.vercel.sh/slurpy",
	},
	{
		name: "lua",
		username: "@lua",
		body: "Nomploy is genuinely so nice to use. The hard work behind it really shows.",
		img: "https://avatar.vercel.sh/lua",
	},
	{
		name: "johnnygri",
		username: "@johnnygri",
		body: "Nomploy is a complete joy to use. I’m running a mix of critical and low-priority services seamlessly across servers.",
		img: "https://avatar.vercel.sh/johnnygri",
	},
	{
		name: "HiJoe",
		username: "@hijoe",
		body: "Setting up Nomploy was great—simple, intuitive, and reliable. Perfect for small to medium-sized businesses.",
		img: "https://avatar.vercel.sh/hijoe",
	},
	{
		name: "johannes0910",
		username: "@johannes0910",
		body: "Nomploy has been a game-changer for my side projects. Solid UI, straightforward Docker abstraction, and great design.",
		...
		>
			<div className="mx-auto max-w-2xl px-4 md:text-center">
				...
				<p className="mt-4 text-center text-lg tracking-tight text-muted-foreground">
					...
					Nomploy made their lives (and deployments) surprisingly easier.
				</p>
			</div>
