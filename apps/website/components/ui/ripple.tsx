	...
	const heroSponsors: AvatarItem[] = [
		{
			...
			link: "https://www.hostinger.com/vps-hosting?ref=nomploy",
			type: "hero",
		},
		{
			name: "LinkDR",
			image: "linkdr-logo.svg",
			link: "https://linkdr.com/?ref=nomploy",
			type: "supporting",
		},
		{
			name: "Lxaer",
			image:
				"https://raw.githubusercontent.com/Nomploy/nomploy/canary/.github/sponsors/lxaer.png",
			link: "https://www.lxaer.com?ref=nomploy",
			type: "hero",
		},
		{
			name: "LambdaTest",
			image: "https://www.lambdatest.com/blue-logo.png",
			link: "https://www.lambdatest.com/?utm_source=nomploy&utm_medium=sponsor",
			type: "premium",
		},
	];
	const premiumSponsors = [
		{
			name: "Supafort",
			image: "supafort.png",
			link: "https://supafort.com/?ref=nomploy",
			type: "premium",
		},
		{
			name: "AgentDock",
			image:
				"https://raw.githubusercontent.com/Nomploy/nomploy/refs/heads/canary/.github/sponsors/agentdock.png",
			link: "https://agentdock.ai/?ref=nomploy",
			type: "premium",
		},
	];
	...
	const eliteSponsors = [
		{
			...
			link: "https://americancloud.com/?ref=nomploy",
			type: "elite",
		},
		{
			name: "Tolgee",
	...
	const supportingSponsors = [
		{
			...
			link: "https://cloudblast.io/?ref=nomploy",
			type: "supporting",
		},
		
		{
			name: "Synexa",
			image:
				"https://raw.githubusercontent.com/Nomploy/nomploy/refs/heads/canary/.github/sponsors/synexa.png",
			link: "https://synexa.ai/?ref=nomploy",
			type: "supporting",
		},
		{
			name: "HahuCloud",
			image: "hahucloud_logo_1.png",
			link: "https://www.hahucloud.com/?ref=nomploy",
			type: "supporting",
		},
		{
			name: "Teramont",
			image: "terramont.ico",
			link: "https://teramont.net/nomploy",
			type: "supporting",
		},
	];
