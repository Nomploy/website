					...
					<div className="mx-auto mt-16 flex w-full flex-col items-center justify-center gap-10 lg:-mx-8 xl:mx-0 xl:gap-x-8">
						...
						<div className="mx-auto flex max-w-4xl flex-col gap-8">
							<div className="flex gap-4 max-sm:flex-wrap max-sm:justify-center sm:flex-row">
								...
								>
									Install and manage Nomploy UI on your own server.
								</p>
								...
								>
									{[
										"Complete Flexibility: Install Nomploy UI on your own infrastructure",
								...
								<div className="mt-4 flex flex-col gap-2">
									<div className="flex flex-col items-center justify-center gap-2">
										...
										<Link
											href="https://docs.nomploy.com/docs/core/installation#docker"
											target="_blank"
							...
							>
								...
								>
									We manage the Nomploy UI infrastructure, we take care of it
									for you.
								</p>
