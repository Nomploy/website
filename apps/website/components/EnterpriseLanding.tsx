...
const features = [
	...
	},
	{
		...
		description:
			"Present Nomploy as your own platform with custom branding, logo, and colors for your organization or clients.",
	},
];
						...
						<div className="text-center">
							...
							>
								...
								<Button variant="outline" className="rounded-full" asChild>
									<Link href="https://docs.nomploy.com" target="_blank">
										View documentation
									</Link>
								</Button>
							</motion.div>
				...
				<Container>
					<div className="mb-16 text-center">
						...
						<p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
							The flexibility to host Nomploy exactly where your business needs
					...
					<div className="mt-12 rounded-2xl border border-border/30 bg-gradient-to-r from-green-500/5 to-blue-500/5 p-8 text-center">
						...
						<p className="mx-auto max-w-2xl text-muted-foreground">
							Need the best of both worlds? Deploy Nomploy across multiple
			...
			<section className="py-20">
				<Container>
					<div className="mb-12 text-center">
						...
						<p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
							AI tools have accelerated how teams ship software. Nomploy gives
					...
					<div className="mx-auto mt-12 max-w-2xl rounded-2xl border border-border/30 bg-gradient-to-r from-green-500/5 to-blue-500/5 p-8 text-center">
						<p className="text-lg text-muted-foreground">
							See how Nomploy handles AI deployment — from AI-generated code to
				...
				<Container>
					<div className="rounded-3xl border border-border/30 bg-gradient-to-br from-green-500/10 via-transparent to-blue-500/10 p-12 text-center">
						...
						<p className="mx-auto mt-6 max-w-2xl text-xl text-muted-foreground">
							...
							Nomploy Enterprise can transform your infrastructure.
						</p>
						<Button
