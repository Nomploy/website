...
export const metadata: Metadata = {
	...
	description:
		"Deploy, test, and share apps internally with Nomploy's sandbox software. Give your team a safe, isolated environment to build without the risk.",
	alternates: {
		canonical: "https://nomploy.com/sandbox-software",
	},
};
...
const vibeCodedFeatures = [
	...
	},
	{
		...
		description:
			"Spin up multiple instances as your team expands. Nomploy's architecture supports the kind of scale that growing companies need, with resources that flex alongside your workload rather than holding you back.",
	},
	{
		icon: KeyRound,
...
const platformFeatures = [
	{
		...
		description:
			"Nomploy supports Docker, Docker Compose, and Nixpacks out of the box, so you can deploy applications built on virtually any stack. Getting a new app into a sandbox environment takes minutes, not days.",
	},
	{
		icon: Layers,
	...
	},
	{
		...
		description:
			"Nomploy connects with GitHub, GitLab, and Bitbucket, so developers can trigger deployments directly from their existing workflows. Integrated CI/CD pipelines mean new features move from commit to sandbox seamlessly.",
	},
	{
		icon: Activity,
...
const enterpriseFeatures = [
	...
	},
	{
		...
		description:
			"Run Nomploy entirely on your own servers, in your own cloud environment, or on-premise. Your data never leaves your infrastructure, especially when you're deploying internal applications or processing sensitive files.",
	},
	{
		icon: Headphones,
		title: "Access dedicated support when you need it",
		description:
			"Enterprise customers get direct access to the Nomploy team for onboarding, troubleshooting, and ongoing support. If something needs fixing in your sandbox environment, you won't be waiting on a community forum.",
	},
	{
		icon: KeyRound,
...
const faqs = [
	...
	},
	{
		...
		answer: [
			...
			"Nomploy is a strong option: it's self-hosted, supports Docker and Compose out of the box, and gives small teams a sandbox environment they can spin up in minutes. It also scales well as your team grows, so you won't need to switch platforms when you do.",
		],
	},
	{
		...
		answer: [
			...
			"Nomploy's multi-environment management and role-based permissions make it a practical choice: you can maintain isolated development environments for each client, deploy new features for review, and keep everything organized from a single dashboard.",
		],
	},
	{
	...
	},
	{
		...
		answer: [
			"The process varies by platform, but with Nomploy, you start by setting up your self-hosted instance, which takes just a few minutes on any VPS.",
	...
	},
	{
		...
		answer: [
			...
			"Nomploy Enterprise runs on your own infrastructure, connects with GitHub and GitLab, includes granular access controls, and supports the kind of scale that B2B teams need as they grow. You can also whitelabel the tool to create a seamless, branded experience for customers.",
			"Nomploy is particularly useful for companies that want to deploy AI-assisted or internally developed applications to employees without routing them through a public-facing environment.",
		],
	},
];
...
export default function SandboxSoftwarePage() {
	return (
		<div className="min-h-screen bg-background">
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Nomploy gives you a fully isolated environment to build, test, and
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							AI-assisted development is moving fast. Nomploy gives your team
					...
					<div className="mt-12 text-center">
						<Button variant="outline" className="rounded-full" asChild>
							<Link href="/deploy-ai">Deploy AI software with Nomploy</Link>
						</Button>
					</div>
				</Container>
			</section>

			{/* The features that make Nomploy a powerful sandbox tool */}
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight sm:text-4xl">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy is designed for teams that need flexibility, security, and
			...
			{/* Nomploy Enterprise: sandbox software built for teams */}
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							For organizations running sandbox environments at scale, Nomploy
					...
					<div className="mt-12 text-center">
						<Button variant="outline" className="rounded-full" asChild>
							<Link href="/enterprise">Discover Nomploy Enterprise</Link>
						</Button>
					</div>
				</Container>
			</section>
				...
				<Container>
					<div className="mx-auto grid max-w-5xl items-center gap-12 lg:grid-cols-2">
						<div>
							...
							<p className="mt-4 text-lg text-muted-foreground">
								Nomploy&apos;s MCP server enables AI agents to interact with
