...
export const metadata: Metadata = {
	title: "Nomploy vs. Vercel: Docker-Native vs. Serverless",
	description:
		"Compare Nomploy vs. Vercel: Docker support, runtime limits, persistent storage, pricing, and full-stack infrastructure. Decide which fits your team.",
};

const featureComparisonRows = [
	{ feature: "Self-hostable on your own VPS or server", nomploy: true, vercel: false },
	...
	{ feature: "One-click scheduled database backups to S3", nomploy: true, vercel: false },
	{ feature: "Long-running processes and background workers", nomploy: true, vercel: false },
	{
		feature: "WebSocket connections without function duration limits",
		nomploy: true,
		vercel: false,
	},
	{ feature: "Unlimited function duration", nomploy: true, vercel: false },
	{ feature: "Custom build servers", nomploy: true, vercel: false },
	{ feature: "Nixpacks build support", nomploy: true, vercel: false },
	{ feature: "Heroku Buildpacks support", nomploy: true, vercel: false },
	{ feature: "Preview deployments", nomploy: true, vercel: true },
	{ feature: "Multi-server deployment", nomploy: true, vercel: false },
	{ feature: "Docker Swarm clustering", nomploy: true, vercel: false },
	...
	{ feature: "Automated metric alerts built in", nomploy: true, vercel: true },
	{ feature: "AI-assisted deployments", nomploy: true, vercel: true },
	{ feature: "MCP server support", nomploy: true, vercel: true },
	{ feature: "API and CLI automation", nomploy: true, vercel: true },
	{ feature: "Fine-grained RBAC", nomploy: true, vercel: false },
	{ feature: "SSO / SAML", nomploy: true, vercel: true },
	{ feature: "Audit logs", nomploy: true, vercel: true },
	{ feature: "Predictable per-server platform pricing", nomploy: true, vercel: false },
	{ feature: "No per-seat billing", nomploy: true, vercel: false },
];
...
const whyChooseItems = [
	...
	},
	{
		...
		description:
			"Nomploy runs apps as containers on servers you control, with no platform-imposed timeouts. Vercel Functions have duration, memory, and payload caps that rule out long-running processes, persistent connections, and media pipelines.",
	},
	{
		icon: HardDrive,
		title: "Keep persistent data on your own servers",
		description:
			"Nomploy supports persistent Docker volumes with scheduled S3 backups, making it a stronger fit for stateful apps, SQLite-backed tools, and self-hosted services that need durable local storage. Vercel's filesystem is read-only outside a small scratch space.",
	},
	{
		icon: Gauge,
...
const pricingRows = [
	{ label: "Pricing model", nomploy: "Per server", vercel: "Per seat + metered usage" },
	{
		label: "Entry price",
	...
	{ label: "Apps per plan", nomploy: "Unlimited", vercel: "Unlimited on Pro" },
	{ label: "Databases", nomploy: "Unlimited per server", vercel: "Not included – third-party add-ons" },
	{
		label: "Bandwidth",
		nomploy: "Included (your server's allowance)",
		vercel: "1 TB included on Pro; metered above that",
	},
	{ label: "Infrastructure", nomploy: "Your own servers (any provider)", vercel: "Vercel-managed only" },
];
...
export default function NomployVsVercelPage() {
	return (
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Learn why so many teams are choosing Nomploy as their application
						...
						<div className="mt-16 grid gap-8 sm:grid-cols-2">
							<div className="rounded-xl border border-border/50 bg-card p-6 text-left">
								...
								<p className="mt-3 text-sm text-muted-foreground">
									Nomploy is built for full-stack, Docker-native deployment on
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Read our comprehensive Vercel vs. Nomploy features comparison
							...
							>
								...
								<div className="flex-1">
									{index === 0 ? (
										...
										<div className="relative aspect-video overflow-hidden rounded-xl border border-border/50">
											<Image
												src="/images/nomploy-deployment-log.png"
												alt="Nomploy application logs streaming from long-running services"
												fill
												className="object-cover object-top"
												sizes="(max-width: 768px) 100vw, 50vw"
											/>
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy Cloud charges per server, not per seat or per function, so
