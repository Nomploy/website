...
export const metadata: Metadata = {
	...
	description:
		"Nomploy's flexible, powerful application and software deployment platform enables self-hosting and secure AI app deployment, with Docker Compose support.",
	alternates: {
		canonical: "https://nomploy.com/lp/deployment-platform",
	},
	robots: {
		index: false,
		follow: false,
...
const competitors = ["Nomploy", "Coolify", "Dokku", "Vercel", "Heroku"];
...
const faqs = [
	{
		...
		answer: (
			<>
				<p>
					Yes. Nomploy supports deploying applications with Docker Compose,
	...
	},
	{
		...
		answer: (
			<>
				<p>
					Nomploy integrates seamlessly with popular version control systems and
				...
				<p className="mt-3">
					If your team already uses GitHub Actions or Atlassian tools, Nomploy
		...
		answer: (
			<>
				<p>
					...
					branch updates, Nomploy can trigger automated deployments and
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Learn why so many development teams are choosing Nomploy.
						</p>
					</div>
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Deploy popular open-source apps in one click with Nomploy
						...
						<div className="mt-10">
							<Button className="rounded-full" asChild>
								<Link
									href="https://templates.nomploy.com"
									target="_blank"
									rel="noopener noreferrer"
								>
									Browse templates
