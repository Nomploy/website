...
export const metadata: Metadata = {
	...
	description:
		"Learn about how Nomploy collects, uses, and safeguards your personal information when you use our website and services.",
};
	...
	return (
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-4 px-4 py-12">
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					At Nomploy, we are committed to protecting your privacy. This Privacy
					Policy explains how we collect, use and safeguard your personal
					information when you use our website (nomploy.com), documentation
					(docs.nomploy.com) and services, including our hosted platform
					(app.nomploy.com). By using Nomploy, you agree to the practices
			...
			<section className="flex flex-col gap-4">
				...
				<div className="flex flex-col gap-2">
					...
					<p>
						When you subscribe to Nomploy Cloud, we use Stripe to process
				...
				<div className="flex flex-col gap-2">
					...
					<p>
						If you deploy applications or databases through Nomploy, our platform
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					data. Nomploy does not sell your personal data.
				</p>
				<p>
