...
export const metadata: Metadata = {
	...
	description:
		"Terms of Service for Nomploy's cloud and on-premise deployment platform.",
};
		...
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-4 px-4 py-12">
			...
			<section className="flex flex-col gap-2">
				...
				<ul className="list-inside list-disc space-y-1">
					...
					<li>
						...
						of the Nomploy platform provided and maintained by us, accessible
						via the internet.
					</li>
					<li>
					...
					<li>
						...
						self-hosted version of the Nomploy platform that Customer installs
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					<a
						href="mailto:contact@nomploy.com"
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					<a
						href="https://docs.nomploy.com/docs/core/remote-servers/security"
						target="_blank"
						rel="noopener noreferrer"
						className="text-primary underline hover:no-underline"
					>
						docs.nomploy.com/docs/core/remote-servers/security
					</a>
					.
				</p>
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					By accepting these Terms, you grant Nomploy a limited, non-exclusive,
					...
					Nomploy in marketing materials, case studies, website pages (including
				...
				<p>
					Nomploy&apos;s Marketing Use of your name and logo is subject to the
					following conditions: (a) Nomploy shall use your logo only in the form
					...
					Nomploy the right to imply your endorsement of any specific Nomploy
					product, feature, or statement without your prior written consent; and
					(c) Nomploy shall not use your name or logo in any manner that is
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					Nomploy and its officers, directors, employees, and agents from any
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					under Nomploy&apos;s Enterprise plan.
				</p>
