...
export const metadata: Metadata = {
	title: "Nomploy Vs. Coolify Comparison",
	description:
		"Nomploy vs. Coolify at a glance: How to choose the right self-hosted open deployment option for your applications.",
};

const featureComparisonRows = [
	{ feature: "One-command installation", nomploy: true, coolify: true },
	{ feature: "Installation feedback and progress logs", nomploy: true, coolify: true },
	{ feature: "Works with firewall and Tailscale out of the box", nomploy: true, coolify: false },
	{ feature: "Lightweight CPU usage while idle", nomploy: true, coolify: false },
	{ feature: "Low memory usage", nomploy: true, coolify: true },
	{ feature: "Teams and organizations support", nomploy: true, coolify: true },
	{ feature: "Projects grouping", nomploy: true, coolify: true },
	{ feature: "Consistent, responsive UI", nomploy: true, coolify: false },
	{ feature: "Built with Next.js / TypeScript", nomploy: true, coolify: false },
	{ feature: "AI-assisted deployments", nomploy: true, coolify: false },
	{ feature: "Deploy from custom Docker images", nomploy: true, coolify: true },
	{ feature: "Database deployment (Postgres, MySQL, Redis, etc.)", nomploy: true, coolify: true },
	{ feature: "Scheduled database backups (S3)", nomploy: true, coolify: true },
	{ feature: "Back up arbitrary Docker volumes, not just databases", nomploy: true, coolify: false },
	{ feature: "Preview deployments (review apps)", nomploy: true, coolify: true },
	{ feature: "API and CLI tools for automation", nomploy: true, coolify: true },
	{ feature: "Multi-server deployment", nomploy: true, coolify: true },
	{ feature: "Docker Swarm clustering", nomploy: true, coolify: "limited" },
	...
	{ feature: "Metrics enabled by default", nomploy: true, coolify: false },
	{ feature: "Automated alerts from metrics", nomploy: true, coolify: false },
];
...
const whyChooseItems = [
	{
		...
		description:
			"Use a single command to deploy with Nomploy, which works seamlessly across firewalls, Tailscale, and secure environments. Launch applications faster with Nomploy's optimized build system.",
	},
	{
		icon: Cpu,
		title: "Do more with less",
		description:
			"Keep your VPS fast and responsive with Nomploy's lightweight architecture, which uses minimal CPU and memory, even while idle. Automate builds, alerts, and scaling events effortlessly.",
	},
	{
		icon: Plug,
		title: "Integrate with your favorite platforms",
		description:
			"Connect Nomploy to GitHub, GitLab, and Bitbucket. Nomploy supports Docker, Compose, Nixpacks, and Buildpacks, and even lets you add APIs and use CLI automation.",
	},
	{
		icon: LayoutDashboard,
		title: "Experience an intuitive, polished UX",
		description:
			"Enjoy a clean, consistent UI in the cloud, powered by Next.js and TypeScript. Nomploy is the modern deployment dashboard, optimized for productivity and clarity, with smooth navigation and predictable save behavior.",
	},
	{
		icon: Bell,
		title: "Know what's happening before it's a problem",
		description:
			"Built-in metrics, automated alerting, and volume backups make Nomploy ideal for serious deployments. Monitor CPU, memory, and disk usage, automate notifications, and keep data safe with S3-compatible backups.",
	},
	{
		icon: Bot,
...
export default function NomployVsCoolifyPage() {
	return (
		<div className="min-h-screen bg-background">
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							...
							lets you run applications on your own VPS or hardware, Nomploy and
			...
			{/* Nomploy vs Coolify at a glance */}
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Read our comprehensive Coolify vs. Nomploy features comparison
				...
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							...
							control. Nomploy's organizational and project structuring features
							...
							hundreds, Nomploy adapts to your needs without adding complexity.
						</p>
					</div>
				</Container>
			</section>
