...
export const metadata: Metadata = {
	...
	description:
		"Create, manage, and back up databases easily with Nomploy's database management tool, and customize the process to suit your project needs.",
};
...
const protectionFeatures = [
	...
	},
	{
		...
		title: "Logs",
		description:
			"View real-time logs from any running database directly in your Nomploy dashboard. Spot errors as they happen, trace unexpected behavior back to its source, and keep a clear record of what\u2019s happening inside your containers.",
	},
	{
		icon: RotateCcw,
		title: "Restore",
		description:
			"Restore any database from a backup stored in your S3 bucket in a few clicks\u2014critical for disaster recovery when you need to act fast. Select the source bucket, search for your backup file with autocomplete, and kick off the restoration process\u2014Nomploy handles the correct restore commands automatically.",
	},
	{
		icon: Link2,
		title: "Connections",
...
const securityFeatures = [
	{
		...
		description:
			"Nomploy creates Docker containers on your own server. Your database data never leaves your infrastructure\u2014you have full ownership and control over where it lives.",
	},
	{
		icon: KeyRound,
	...
	},
	{
		...
		description:
			"Nomploy doesn\u2019t store or proxy your data. Everything runs on your machine, so there\u2019s no middleman between your applications and your databases.",
	},
];
...
const faqs = [
	...
	},
	{
		...
		answer:
			"There\u2019s no single best tool. The right choice depends on your specific use cases, team size, and infrastructure. Some tools require expertise to configure and come with a steeper learning curve, which can slow teams down. Nomploy is designed to remove that friction and improve database performance, offering a secure, scalable solution that covers deployment, monitoring, backups, and data privacy without requiring specialist knowledge. It won\u2019t replace dedicated analysis or AI assistant tooling, but it gives developers a reliable foundation for managing databases in production.",
	},
	{
		question: "What database systems does Nomploy support?",
		answer:
			"Nomploy supports five widely used database tools: PostgreSQL, MySQL, MariaDB, MongoDB, and Redis. That covers the most common SQL server databases and NoSQL use cases, from relational workloads that rely on structured query language to flexible document and key-value stores. All five\u2014both SQL databases and noSQL systems\u2014can be deployed, backed up, and monitored using the same tools and workflows inside Nomploy.",
	},
];
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Create, manage, and back up databases easily with Nomploy&apos;s
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy&apos;s database management tool supports five widely used
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Nomploy surfaces live monitoring graphs for memory, CPU, disk, and
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy goes beyond the basics, giving you granular control over
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Your database data is stored on your own server. Nomploy creates
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Nomploy gives you everything you need to deploy, monitor, and
