...
const configFeatures = [
	...
	},
	{
		...
		description:
			"Decide on your retention period and an automated cron job will clean old metrics. Choose which port the Nomploy metrics server listens on—the default is 4500.",
	},
	{
		icon: Server,
...
const relatedFeatures = [
	...
	},
	{
		...
		description:
			"Provision, manage, and back up databases without leaving Nomploy.",
...
const faqs = [
	...
	},
	{
		...
		answer:
			"The best server monitoring software depends on what you need to monitor and whether you want open-source control or a managed SaaS. If you're using Nomploy, you get real-time server monitoring as part of your solution on all plans—with no additional setup required once your server is deployed.",
	},
];
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Use Nomploy&apos;s container monitoring dashboard as soon as
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Set up your Nomploy dashboard to suit your needs with different
							configuration options.
						</p>
					</div>
					<div className="mx-auto mt-16 grid max-w-5xl gap-8 sm:grid-cols-2">
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Take advantage of Nomploy&apos;s comprehensive container and server
