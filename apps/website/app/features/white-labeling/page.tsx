...
export const metadata: Metadata = {
	...
	description:
		"Rebrand Nomploy as your own product. Customize the name, logo, colors and more to deliver a seamless experience under your own brand.",
};
...
const coreFeatures = [
	{
		...
		description:
			"Replace Nomploy across the entire interface with your own application name. Upload your logo for the sidebar, header, and login page, and set a custom favicon so your branding carries through to the browser tab.",
	},
	{
		icon: Palette,
	...
	},
	{
		...
		description:
			"Set your own page title, footer text, sidebar links, and more for documentation and support, so users are always directed to your resources, not Nomploy\u2019s.",
	},
	{
		icon: MonitorCheck,
...
const relatedFeatures = [
	{
		...
		title: "RBAC",
		description:
			"Define exactly what each user can do once they\u2019re in Nomploy, with fine-grained permissions across projects, features, and services.",
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Replace every Nomploy mention with your own name, logo, branding,
							and visual identity.
						</p>
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy&apos;s white labeling lets enterprise teams and agencies
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Talk to us about white labeling and the rest of Nomploy&apos;s
