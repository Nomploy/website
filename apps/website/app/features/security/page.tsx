...
export const metadata: Metadata = {
	...
	description:
		"Nomploy gives teams enterprise-grade security with SSO, fine-grained RBAC, audit logs, and 2FA – built for compliance and infrastructure control.",
};
...
const ssoFeatures = [
	{
		...
		description:
			"Nomploy's SSO supports both OpenID Connect and SAML 2.0, so it works with virtually any enterprise IdP—no custom engineering work required.",
	},
	{
		icon: Plug,
	...
	},
	{
		...
		description:
			"When you add or remove a user in your IdP, it's reflected in Nomploy. No parallel user management, no accounts lingering after someone leaves.",
	},
	{
		icon: ShieldCheck,
		title: "Enforce your auth policies",
		description:
			"MFA requirements, session timeouts, and conditional access rules configured in your IdP apply to Nomploy automatically so your security posture stays consistent.",
	},
];
...
const infrastructureFeatures = [
	...
	},
	{
		...
		description:
			"Nomploy handles certificate provisioning and renewal automatically via Traefik, so your services stay encrypted without manual intervention or renewal tracking.",
	},
	{
		icon: KeyRound,
		title: "Authenticate with SSH keys, not passwords",
		description:
			"Nomploy's built-in security checks recommend disabling password authentication on your servers and switching to key-based SSH. You can manage your keys directly within the platform.",
	},
	{
		icon: Server,
		title: "Keep your data on your own infrastructure",
		description:
			"Self-hosted Nomploy means your deployments, credentials, and configurations stay on servers you control. No vendor accesses your environment.",
	},
];
...
const relatedFeatures = [
	...
	},
	{
		...
		title: "RBAC",
		description:
			"Define exactly what each user can do once they're in Nomploy, with granular role and permission controls across projects, services, and features.",
	...
	},
	{
		...
		title: "Audit logs",
		description:
			"Keep a full record of every login, logout, and action taken across your Nomploy environment for compliance and accountability.",
...
const faqs = [
	{
		question: "What SSO providers does Nomploy support?",
		answer:
			"Nomploy supports any OIDC or SAML 2.0 provider. Pre-configured integrations are available for Okta, Azure AD (now Microsoft Entra ID), Auth0, Keycloak, and Zitadel. If your provider isn't listed, you can configure it manually using standard endpoints.",
	},
	{
	...
	{
		question: "Does Nomploy support SOC 2 or GDPR compliance?",
		answer:
			"Nomploy's Enterprise features—SSO, custom RBAC, and audit logs—are designed to support compliance with SOC 2, GDPR, and internal governance requirements. For MSA/SLA and compliance documentation, contact the Nomploy team.",
	},
	{
		question: "Can I use SSO on Nomploy Cloud and self-hosted?",
		answer:
			"SSO is available on both Nomploy Cloud and self-hosted Enterprise instances. Contact sales for configuration support.",
	},
];
		...
		<div className="min-h-screen bg-background">
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Nomploy gives you layered security at every level, from how your
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							...
							runs Okta, Azure AD, or Keycloak, Nomploy connects to it.
						</p>
					</div>
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Access control is only one part of the picture. Nomploy is built
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight sm:text-4xl">
							Explore Nomploy&apos;s security features in depth
						</h2>
						<p className="mt-4 text-lg text-muted-foreground">
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight sm:text-4xl">
							Deploy securely with Nomploy
						</h2>
						<p className="mt-4 text-lg text-muted-foreground">
							Start shipping applications today with Nomploy, safe in the
