...
export const metadata: Metadata = {
	...
	description:
		"Monitor, control, and maintain your business applications from a single dashboard with Nomploy's application management software.",
};
...
const faqs = [
	{
		...
		answer:
			"Application performance management software helps IT teams monitor application health, track resource usage, and identify performance issues before they affect users. Key features typically include real-time monitoring of CPU, memory, disk, and network usage, alongside log access and alerting. Nomploy covers the operational side of application performance management: giving teams live usage data, deployment history, and rollback capabilities from a single dashboard, without requiring specialist expertise or separate tooling.",
	},
	{
		question: "What is the best application management software?",
		answer:
			"The best application management software depends on your business needs, team size, and technical expertise. Enterprise platforms often come with deep integration capabilities and reporting features, but they can require significant investment and a steeper learning curve. Nomploy is built for teams that want operational efficiency without that overhead. It covers the key processes of application management, including monitoring, rollbacks, environment configuration, and scheduled jobs, in a platform you can self-host or run in the cloud so that your IT team can run on your own infrastructure if they want. It\u2019s a strong fit for organizations that want to manage business applications with full control and without vendor lock-in.",
	},
	{
		question: "What is application lifecycle management software?",
		answer:
			"Application lifecycle management (ALM) software supports the full lifecycle of a software application, from requirements and development through deployment, ongoing maintenance, and eventual retirement. It connects strategic planning and business objectives with day-to-day operational execution. Nomploy focuses on the operational slice of that lifecycle\u2014standardizing how applications are deployed, monitored, rolled back, and maintained\u2014which is where most teams experience the most friction. For organizations going through digital transformation or modernization initiatives, having that operational foundation in place is what makes broader lifecycle management sustainable.",
	},
];
...
export default function ApplicationManagementSoftwarePage() {
	return (
		<div className="min-h-screen bg-background">
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							...
							single dashboard. Nomploy gives your IT team the visibility and
				...
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							...
							Nomploy. Get a clear view of application health, resource usage,
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							...
							step toward better application management. Nomploy surfaces the
					...
					<div className="mx-auto max-w-5xl lg:grid lg:grid-cols-2 lg:gap-16">
						<div>
							...
							<p className="mt-4 text-sm text-muted-foreground">
								Nomploy gives teams a consistent application management system
			...
			{/* Run Nomploy where your business needs it */}
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight sm:text-4xl">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Deploy Nomploy on your own infrastructure or ours. Both options
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Use Nomploy to create sandbox environments separated from production infrastructure, where technical and non-technical employees can launch AI-coded apps safely.
						</p>
					</div>
					<div className="mx-auto mt-16 grid max-w-4xl gap-8 sm:grid-cols-3">
						{[
							...
							},
							{
								...
								description:
									"Once Nomploy is set up, team members can take AI-coded apps from a Git repo, Docker image, or Compose file to a running environment without engineering support.",
							},
							{
								number: "3",
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Nomploy gives your IT team the application management software it
							needs to monitor, maintain, and scale business applications with
							confidence. Get started in minutes.
						</p>
						<div className="mt-10">
							<Button className="rounded-full" asChild>
