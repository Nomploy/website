...
export const metadata: Metadata = {
	...
	description:
		"Nomploy's flexible, powerful application and software deployment platform enables you to put code written in Node.js, PHP, Python, Go, and Ruby live.",
};
...
const professionalFeatures = [
	{
		...
		description:
			"Deploy apps written in Node, PHP, Python, Go, Ruby, and more. Nomploy does not restrict programming languages.",
	},
	{
		icon: Layers,
		title: "Deploy any app with any stack",
		description:
			"Nomploy supports single services and multi-service apps. Deploy from Git, a container registry, or Docker Compose.",
	},
	{
		icon: Wrench,
...
const aiDeploymentFeatures = [
	{
		...
		description:
			"Once Nomploy is set up, non-technical users can take code from an AI tool to a running app without engineering support.",
	},
	{
		icon: Layers,
	...
	},
	{
		...
		description:
			"Nomploy's MCP server lets AI agents trigger deployments, query app state, and manage services without a custom integration.",
	},
	{
		icon: Shield,
...
const faqs = [
	...
	{
		question: "Can I use Nomploy to deploy AI-generated apps?",
		answer:
			"Yes. Nomploy works with code from any source, including apps built or scaffolded by AI coding tools. You deploy using the same Git, Docker, and Compose workflows as any other application—there's no separate process for AI-generated code.",
	},
];
...
export default function ApplicationDeploymentPlatformPage() {
	return (
		<div className="min-h-screen bg-background">
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							AI coding tools are changing how applications get written. Nomploy handles the deployment side, from AI-generated code to a live URL, powered by your existing workflows.
						</p>
					</div>
					...
					<div className="mx-auto mt-16 max-w-2xl rounded-xl border border-border/50 bg-card p-8 text-center">
						...
						<p className="mt-3 text-muted-foreground">
							See how Nomploy handles sandboxed deploys, non-technical users, and enterprise security for AI-built apps.
						</p>
						<div className="mt-6">
							<Button className="rounded-full" asChild>
								<Link href="/enterprise">Deploy AI tools with Nomploy</Link>
							</Button>
						</div>
					</div>
				</Container>
			...
			{/* Host Nomploy where your business needs it */}
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Deploy popular open-source apps in one click with Nomploy Templates,
			...
			<section className="border-b border-border/30 py-12 sm:py-16">
				<Container>
					<div className="mx-auto max-w-6xl overflow-hidden rounded-xl border border-border/50 shadow-2xl">
						<Image
							src="/dashboard.png"
							alt="Nomploy dashboard showing projects and deployed services"
							width={1200}
							height={750}
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy is the software deployment platform for shipping anything
