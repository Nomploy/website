...
export const metadata: Metadata = {
	...
	description:
		"Track every action across your Nomploy organization. Audit logs give enterprise teams the visibility they need for security and compliance.",
};
...
const coreFeatures = [
	{
		...
		description:
			"Audit logs capture authentication events, user management changes, deployment activity, infrastructure updates, environment variable changes, backup configuration, and more. If it happened in Nomploy, it\u2019s recorded.",
	},
	{
		icon: AlertCircle,
		title: "Investigate issues quickly",
		description:
			"Each log entry includes a timestamp, the user who performed the action, the action type, the resource affected, and the user\u2019s role in Nomploy at the time. When something goes wrong, you have everything you need to trace it back to its source.",
	},
	{
		icon: Search,
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Know exactly who did what, and when, across your entire Nomploy
							organization.
						</p>
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Talk to us about audit logs and the rest of Nomploy&apos;s
