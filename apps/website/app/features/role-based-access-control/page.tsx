...
export const metadata: Metadata = {
	...
	description:
		"Control who can access what across your Nomploy projects. Fine-grained RBAC keeps your infrastructure secure as your team scales.",
};
...
const coreFeatures = [
	{
		...
		description:
			"Assign owners, admins, and members across your organization, with each role scoping what that user can access and action within Nomploy.",
	},
	{
		icon: FolderLock,
...
const relatedFeatures = [
	...
	},
	{
		...
		title: "Audit logs",
		description:
			"Keep a full record of every action taken across your Nomploy environment for compliance and accountability.",
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							RBAC in Nomploy lets you define exactly what each person on your
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							...
							Nomploy&apos;s higher-tier feature set.
						</p>
						<div className="mt-10">
							<Button className="rounded-full" asChild>
