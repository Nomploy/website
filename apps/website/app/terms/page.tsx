...
export const metadata: Metadata = {
	...
	description:
		"Read the terms and conditions for using Nomploy's website and services.",
};
	...
	return (
		<div className="mx-auto flex w-full max-w-4xl flex-col gap-4 px-4 py-12">
			...
			<section className="flex flex-col gap-2">
				<p>
					Welcome to Nomploy! These Terms and Conditions outline the rules and
					regulations for the use of Nomploy's website and services.
				</p>
				<p>
				...
				<p className="">
					Website: Refers to the website of Nomploy (
					<a
				...
				<p>
					Services: The platform and related services offered by Nomploy for
					deploying and managing applications using Docker and other related
					tools.
				</p>
				<p>User: Any individual or organization using Nomploy.</p>
				<p>
			...
			<section className="">
				...
				<p className="mb-4">
					Nomploy is a platform that allows users to deploy and manage web
					applications on their own servers using custom builders and Docker
					technology. Nomploy offers both free and paid services, including
			...
			<section className="flex flex-col gap-2">
				...
				<p className="">
					...
					servers, and applications deployed through Nomploy.
				</p>
				<p className="">
				...
				<p className="">
					...
					connection with their use of Nomploy.
				</p>
			</section>
			...
			<section className="">
				...
				<p className="mb-4">
					Due to the nature of our digital services, Nomploy operates on a
					no-refund policy for any paid subscriptions, except where required by
					law. We offer a self-hosted version of Nomploy with the same core
			...
			<section className="flex flex-col gap-2">
				...
				<p className="">
					Nomploy is provided "as is" without any warranties, express or
				...
				<p className="">
					...
					servers or the environment where Nomploy is deployed. Any changes to
					the server configuration, system settings, security policies, or other
					environments that deviate from the recommended use of Nomploy may
					result in compatibility issues, performance degradation, or security
					vulnerabilities. Additionally, Nomploy may not function properly on
			...
			<section className="flex flex-col gap-2">
				...
				<p className="">
					Nomploy retains all intellectual property rights to the platform,
					including code, design, and content.
				</p>
				<p className="">
					Users are granted a limited, non-exclusive, and non-transferable
					license to use Nomploy in accordance with these terms.
				</p>
				<p className="">
			...
			<section className="">
				...
				<p className="mb-4">
					Nomploy reserves the right to suspend or terminate access to the
			...
			<section className="">
				...
				<p className="mb-4">
					Nomploy reserves the right to update these Terms & Conditions at any
			...
			<section className="">
				...
				<p className="mb-4">
					Email:{" "}
					<a
						href="mailto:support@nomploy.com"
						className="text-blue-500 hover:underline"
					>
						support@nomploy.com
					</a>
