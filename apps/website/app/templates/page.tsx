...
export const metadata: Metadata = {
	...
	description:
		"Browse 500+ open source templates ready to deploy on Nomploy with one click. Self-host databases, CMS, analytics, AI tools, and more with Docker Compose.",
	alternates: {
		canonical: "https://nomploy.com/templates",
	},
	openGraph: {
		title: "Nomploy Open Source Templates",
		description:
			"Browse 500+ open source templates ready to deploy on Nomploy with one click.",
		type: "website",
		...
		<div className="container mx-auto max-w-7xl px-4 py-12 mt-14">
			<div className="mb-8">
				...
				<p className="mt-3 max-w-2xl text-lg text-muted-foreground">
					...
					deploy on Nomploy with a single click.
				</p>
			</div>
