...
export const metadata: Metadata = {
	...
	description:
		"Start using Nomploy, the free, open source PaaS that enables developers to deploy apps and databases on their own infrastructure.",
	alternates: {
		canonical: "https://nomploy.com/self-hosted-paas",
	},
};
...
const controlFeatures = [
	{
		...
		description:
			"Run Nomploy on any VPS or bare metal server you already own. No per-seat fees, no per-deployment charges—just your underlying infrastructure costs.",
	},
	{
		icon: Unlock,
...
const setupSteps = [
	{
		...
		description:
			"Spin up any Linux VPS from a cloud provider of your choice, or use hardware you already own. Nomploy has minimal overhead and runs comfortably on modest specs.",
	},
	{
		number: "02",
		icon: TerminalSquare,
		...
		description:
			"Install Nomploy with a single command. Docker is the only prerequisite, the installer handles the rest in just a few commands.",
	},
	{
		number: "03",
		...
		description:
			"Once installed, open the Nomploy web UI in your browser, create your admin account, and you're in. No complex cluster setup, no Kubernetes complexity.",
	},
	{
		number: "04",
		icon: GitBranch,
...
const faqs = [
	{
		...
		answer: (
			<>
				...
				<p className="mt-3">
					Nomploy is an open source PaaS you can install on any server with a
					single command.
				</p>
			</>
		),
	},
	{
		...
		answer: (
			<>
				...
				<p className="mt-3">
					Nomploy is a strong open source PaaS alternative to Heroku and similar
	...
	{
		question: "Is Nomploy really free to self-host?",
		answer: (
			<p>
				Yes. The open source version of Nomploy is free to install and run on
				your own servers. You pay only for the infrastructure you provision,
				meaning no per-seat or per-deployment fees. Nomploy Cloud plans start at
				$4.50 per server per month if you prefer managed uptime.
			</p>
		),
	},
	{
		question: "What's the difference between Nomploy Cloud and self-hosted?",
		answer: (
			<p>
				...
				is purely operational: with self-hosted, you manage the Nomploy instance
				itself, including updates and uptime. With Cloud, Nomploy manages the
	...
	{
		question: "Does Nomploy support multi-tenancy?",
		answer: (
			<p>
				Yes. Nomploy includes multi-tenancy support via organizations and
	...
	{
		question: "What infrastructure does Nomploy support?",
		answer: (
			<p>
...
const INSTALL_COMMAND = "curl -sSL https://nomploy.com/install.sh | sh";
		...
		<div className="min-h-screen bg-background">
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Nomploy is a free, open source PaaS that enables developers to
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							...
							Nomploy Enterprise adds the security, compliance, and support
							features that larger teams require, deployable on-premises or in
							your own cloud, with no external dependencies.
						</p>
						<div className="mt-8">
							<Button className="rounded-full" asChild>
								<Link href="/enterprise">Learn more about Nomploy Enterprise</Link>
							</Button>
						</div>
					</div>
					<div className="mx-auto mt-16 max-w-3xl">
						<h3 className="text-center text-lg font-semibold text-white">
							What you get with Nomploy Enterprise
						</h3>
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight sm:text-4xl">
							How to get set up with self-hosted Nomploy
						</h2>
						<p className="mt-4 text-lg text-muted-foreground">
							Getting a self-hosted PaaS running doesn&apos;t have to be an
							infrastructure project. Nomploy is designed for minimal overhead,
					...
					<div className="mx-auto mt-16 grid max-w-5xl gap-8 sm:grid-cols-2">
						<div className="rounded-xl border border-border/50 bg-card p-8">
							...
							<p className="mt-3 text-sm text-muted-foreground">
								...
								bills, full control over everything, or need to run Nomploy in
						...
						<div className="rounded-xl border border-border/50 bg-card p-8">
							...
							<p className="mt-3 text-sm text-muted-foreground">
								Choose Cloud if you&apos;d rather not maintain the Nomploy
								instance itself. Your apps still run on your own servers —
								Nomploy manages the control plane for you.
							</p>
							<ul className="mt-6 space-y-3 text-sm text-muted-foreground">
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy&apos;s deployment engine is identical in both options. The
					...
					<div className="mx-auto mt-16 grid max-w-4xl gap-8 sm:grid-cols-2">
						...
						<div className="rounded-xl border border-border/50 bg-card p-6 text-center">
							...
							<h3 className="text-xl font-semibold">Nomploy Cloud</h3>
							<p className="mt-3 text-sm text-muted-foreground">
