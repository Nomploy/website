...
export const metadata: Metadata = {
	title: "Deploy AI Apps Securely with Nomploy",
	description:
	...
	alternates: {
		canonical: "https://nomploy.com/deploy-ai",
	},
};
...
const coreFeatures = [
	{
		icon: Bot,
		title: "Connect AI agents directly to Nomploy",
		description:
			"Nomploy's MCP server enables AI agents to interact with your deployment environment through the Model Context Protocol. An AI tool can trigger deployments, query application state, and manage services—without needing a custom integration.",
	},
	{
		icon: Boxes,
		title: "Deploy any app, from any source",
		description:
			"Whether it's a Git repo, a Docker image, or a Docker Compose file, Nomploy handles it. Non-technical users can go from AI-generated code to a running application without a DevOps team in the loop.",
	},
	{
		icon: Activity,
...
const guardrailFeatures = [
	{
		...
		description:
			"Nomploy's multitenancy keeps projects and data isolated at the team level. One team can't see, access, or interfere with another's applications, so AI experimentation stays contained without needing a separate instance per team.",
	},
	{
	...
	},
	{
		...
		description:
			"Nomploy supports SSO via Okta, Azure AD, Auth0, and more, with SCIM provisioning and deprovisioning. When someone joins a team, they get access. When they leave, it's revoked automatically—no manual cleanup, no lingering credentials.",
		link: {
...
const testFreelyPoints = [
	...
	"Audit logs record every action across your Nomploy environment",
		...
		<div className="min-h-screen bg-background">
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							...
							Nomploy will give them a safe, governed environment to ship those
				...
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Nomploy is built to take an app from an AI coding tool to a live,
			...
			<section className="border-b border-border/30 bg-black py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							AI-generated code moves fast. Nomploy&apos;s enterprise features
				...
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							...
							can self-host on Nomploy with a single template deploy. It gives
						...
						<div className="mt-10">
							<Button variant="outline" className="rounded-full" asChild>
								<Link
									href="https://docs.nomploy.com/docs/templates/openclaw"
									target="_blank"
			...
			<section className="border-b border-border/30 py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-2xl text-center">
						<h2 className="font-display text-3xl tracking-tight sm:text-4xl">
							Unlock Your Deployment Potential with Nomploy Cloud
						</h2>
						<p className="mt-4 text-lg text-muted-foreground">
							Say goodbye to infrastructure hassles, Nomploy Cloud handles it
