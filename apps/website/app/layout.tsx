...
export const metadata: Metadata = {
	metadataBase: new URL("https://nomploy.com"),
	title: {
		default: "Nomploy - Deploy your applications with ease",
		template: "%s | Nomploy",
	},
	description: "Deploy your applications with ease using Nomploy",
	icons: {
		icon: "/icon.svg",
		apple: "/apple-touch-icon.png",
	},
	openGraph: {
		title: "Nomploy - Deploy your applications with ease",
		description: "Deploy your applications with ease using Nomploy",
		images: "/og.png",
		type: "website",
	},
