...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://nomploy.com/industries/agencies",
	},
};
...
const data: IndustryPageData = {
	hero: {
		...
		description:
			"Launch client websites, SaaS products, internal tools, vibe-coded software, and campaign apps without rebuilding the deployment process every time. Nomploy gives agencies a repeatable release platform with previews, domains, logs, databases, and client-ready governance.",
	},
	features: {
		heading: "Ship client projects faster without messy hosting handoffs",
		description:
			"Agencies need a deployment model that works across clients, stacks, domains, and production requirements. Nomploy helps teams move from repo to live app with less manual setup and more visibility after launch.",
		items: [
			{
				icon: GitBranch,
			...
			},
			{
				...
				description:
					"Connect your AI agent to Nomploy with the MCP, so team members and clients can manage deployments with prompts, or even autonomously.",
			},
			{
				icon: Paintbrush,
	...
	comparison: {
		...
		description:
			"Nomploy gives your software building and deployment agency a single operating model to build, review, launch, and support client apps.",
		without: {
	...
	workflow: {
		...
		description:
			"Nomploy helps agencies turn deployment into a repeatable client delivery process. New projects can follow the same workflow, even when the technology stack changes.",
		steps: [
			{
			...
			},
			{
				...
				description:
					"Connect the client app from Git or configure a Docker-based deployment. Nomploy can trigger releases from webhooks when changes are pushed.",
	...
	builtFor: {
		...
		paragraphs: [
			"Nomploy gives agencies a cleaner way to manage multiple apps, clients, and release workflows.",
		...
		screenshotAlt:
			"Nomploy dashboard showing an agency project with web, API, database and worker services, and an environment selector with production and staging",
	},
	detailRows: [
		{
		...
		items: [
			{
				...
				answer:
					"A deployment agency platform is software that helps agencies deploy, manage, and support client applications across multiple projects. Nomploy gives teams one place for apps, environments, domains, logs, databases, and deployments.",
			},
			{
				question: "Can Nomploy handle multiple client projects?",
				answer:
			...
			{
				question: "Does Nomploy support whitelabeling?",
				answer:
					"Nomploy Enterprise includes whitelabeling for self-hosted setups, along with SSO, custom roles, and audit logs.",
			},
			{
				question: "Can agencies deploy Docker Compose apps?",
				answer:
					"Yes. Nomploy supports Docker Compose for multi-service applications, which is useful when client projects include APIs, databases, workers, queues, or supporting services.",
			},
		],
	},
};
