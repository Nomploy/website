...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://nomploy.com/industries/manufacturing",
	},
};
...
const data: IndustryPageData = {
	hero: {
		...
		description:
			"Deploy plant-floor apps, integration services, dashboards, and internal tools without relying on unmanaged servers or manual release steps. Nomploy gives manufacturing technology teams a repeatable platform for controlled deployments.",
	},
	features: {
		...
		items: [
			...
			},
			{
				...
				description:
					"Nomploy supports Git providers, Docker, Docker Compose, Nixpacks, Buildpacks, and custom Dockerfiles.",
			},
			{
				icon: Workflow,
	...
	comparison: {
		...
		description:
			"Manufacturing teams often run critical internal software on local servers, one-off scripts, and legacy handoff processes. Nomploy creates a more consistent deployment model without forcing teams into a heavy platform build.",
		without: {
		...
		withNomploy: {
			title: "Nomploy for manufacturing",
			items: [
	...
	workflow: {
		...
		description:
			"Nomploy helps manufacturing technology teams make releases more repeatable. The same workflow can support a plant dashboard, integration service, internal API, or operations tool.",
		steps: [
			{
			...
			},
			{
				...
				description:
					"Connect a Git repository, Docker image, Docker Compose file, or supported build method. Nomploy can automate deployment when approved changes are pushed.",
	...
	builtFor: {
		...
		paragraphs: [
			"Nomploy gives manufacturing technology teams a way to standardize application deployment without removing flexibility.",
		...
		screenshotAlt:
			"Nomploy dashboard for a manufacturing operations project with production and staging environments and running services",
	},
	detailRows: [
		{
		...
		},
		{
			...
			support:
				"Self-hosted Nomploy, Nomploy Cloud, remote servers, and multi-server management",
		},
		{
			area: "Databases",
	...
	faqs: {
		...
		items: [
			...
			{
				question: "Can Nomploy support plant-floor apps?",
				answer:
					"Yes. Nomploy can deploy web apps, APIs, Docker Compose services, background workers, and databases that support manufacturing operations and internal tooling.",
			},
			{
			...
			{
				question: "Can manufacturing teams self-host Nomploy?",
				answer:
					"Yes. Nomploy can be self-hosted, and Nomploy Cloud can manage the control plane while applications run on servers connected by your team.",
			},
		],
	},
};
