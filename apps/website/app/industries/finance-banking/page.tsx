...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://nomploy.com/industries/finance-banking",
	},
};
...
const data: IndustryPageData = {
	hero: {
		...
		description:
			"Deploy internal banking tools, fintech services, and customer-facing apps without giving up control of infrastructure. Nomploy gives financial technology teams a governed platform for private deployment and ongoing operations.",
	},
	features: {
		heading: "Ship regulated software without slowing release teams",
		description:
			"Financial institutions need software teams to move quickly, but deployments need clear boundaries. Nomploy lets developers release from Git and Docker-based workflows while platform teams manage access, environments, logs, and rollback paths.",
		items: [
			{
				icon: Lock,
	...
	comparison: {
		...
		description:
			"Separate cloud accounts can work for individual projects, but they become difficult to govern across banking products, internal tools, and compliance-sensitive workflows. Nomploy centralizes the deployment layer while keeping teams productive.",
		without: {
		...
		withNomploy: {
			title: "Nomploy for finance and banking",
			items: [
	...
	workflow: {
		...
		description:
			"Nomploy turns release management into a clear workflow. Developers can ship from their repositories, while platform teams keep the environment, access model, process, and release path consistent.",
		steps: [
			{
			...
			},
			{
				...
				description:
					"Connect a Git provider or bring a Docker-based deployment. Nomploy can trigger deployments through webhooks when approved changes are pushed.",
	...
	builtFor: {
		...
		paragraphs: [
			"Nomploy gives finance teams a practical middle ground between unmanaged cloud hosting and heavy internal platform projects.",
			...
			"Teams can run Nomploy in the model that fits their requirements. Use Nomploy Cloud when you want the control plane managed by Nomploy and apps running on your own servers, or choose self-hosting when the full platform should stay under internal operations.",
		],
		screenshotAlt:
			"Nomploy project dashboard for a banking platform with separate production and staging environments and running services",
	},
	detailRows: [
		{
	...
	faqs: {
		...
		items: [
			...
			{
				question: "Can Nomploy support internal banking tools?",
				answer:
					"Yes. Nomploy can deploy internal tools, dashboards, APIs, background services, and database-backed applications from the same platform. Teams can use self-hosted or managed control-plane models depending on infrastructure policy. Nomploy empowers finance teams to build and test internal tools, including vibe-coded and AI-powered apps, in safe sandbox environments.",
			},
			{
				question: "Does Nomploy support SSO and access control?",
				answer:
					"Nomploy Enterprise includes single sign-on, custom roles, audit logs, and whitelabeling. These options help platform teams define who can view, deploy, manage, or audit services.",
			},
			{
				question: "Can finance teams use Docker Compose with Nomploy?",
				answer:
					"Yes. Nomploy supports Docker Compose for more complex services, including applications that need multiple containers, databases, queues, or supporting infrastructure.",
			},
			{
				question:
					"Should financial institutions choose Nomploy Cloud or self-hosted Nomploy?",
				answer:
					"Use Nomploy Cloud when you want Nomploy to manage the control plane while your apps run on your own servers. Choose self-hosted Nomploy when your institution wants to operate the full platform internally.",
			},
		],
	},
};
