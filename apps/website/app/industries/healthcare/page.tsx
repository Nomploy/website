...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://nomploy.com/industries/healthcare",
	},
};
...
const data: IndustryPageData = {
	hero: {
		...
		description:
			"Deploy patient-facing apps, clinical operations tools, and healthcare technology in environments your IT teams can govern. Nomploy supports private deployment in healthcare with self-hostable infrastructure, access control, and review workflows.",
	},
	features: {
		heading: "Release healthcare technology without exposing infrastructure",
		description:
			"Healthcare technology deployment needs a balance between speed and control. Nomploy enables developers to publish apps efficiently while IT teams keep infrastructure, access, and operational visibility in one place.",
		items: [
			{
				icon: Lock,
				title: "Deploy clinical apps inside controlled environments",
				description:
					"Run patient portals, care team tools, internal dashboards, and service APIs in environments managed by you with self-hosted Nomploy.",
			},
			{
				icon: KeyRound,
	...
	comparison: {
		...
		description:
			"Nomploy gives teams a more consistent way to release and operate healthcare software, rather than a mix of internal servers, cloud projects, vendor portals, and one-off deployment scripts.",
		without: {
		...
		withNomploy: {
			title: "Nomploy for healthcare deployment",
			items: [
	...
	workflow: {
		...
		description:
			"Nomploy gives healthcare technology teams a repeatable path from code to a running application. Developers can keep working from Git while IT teams manage the release environment.",
		steps: [
			{
			...
			},
			{
				...
				description:
					"Connect a Git provider or bring a Docker-based configuration. Nomploy supports common deployment methods, so teams can match the workflow to the application stack.",
	...
	builtFor: {
		...
		paragraphs: [
			"Nomploy gives healthcare technology teams a practical deployment layer for apps that need tighter operational control.",
			...
			"For organizations with stricter infrastructure needs, Nomploy can be self-hosted. Teams that want Nomploy to manage the control plane can use Nomploy Cloud while connecting their own servers for application workloads.",
		],
		screenshotAlt:
			"Nomploy dashboard for a healthcare technology project with production and staging environments and running services",
	},
	detailRows: [
		{
	...
	faqs: {
		...
		items: [
			...
			},
			{
				...
				answer:
					"Healthcare technology deployment often needs tighter control over access, infrastructure, review workflows, and operational visibility. Nomploy helps by keeping releases, environments, logs, monitoring, and access management closer together, while also offering self-hosted deployment.",
			},
			{
				question: "Can Nomploy support private deployment in healthcare?",
				answer:
					"Yes. Nomploy can be self-hosted, and Nomploy Cloud lets teams connect their own servers while Nomploy manages the control plane. This gives healthcare teams options for private deployment in healthcare environments.",
			},
			{
			...
			{
				question: "Does Nomploy support healthcare app databases?",
				answer:
					"Yes. Nomploy supports common databases, including PostgreSQL, MySQL, MongoDB, Redis, and MariaDB, along with backup options for supported services.",
			},
		],
	},
};
