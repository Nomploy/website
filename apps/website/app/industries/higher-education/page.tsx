...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://nomploy.com/industries/higher-education",
	},
};
...
const data: IndustryPageData = {
	hero: {
		...
		description:
			"Give students a real deployment experience securely. Nomploy provides IT and academic technology teams with a controlled platform for student apps, course projects, and internal teaching tools.",
	},
	features: {
		heading: "Let students ship real apps without creating shadow IT",
		description:
			"Students need to deploy, test, and share the apps they've built. In Nomploy, higher education institutions get a deployment platform that keeps app publishing inside an environment your teams can control.",
		items: [
			{
				icon: Box,
			...
			},
			{
				...
				description:
					"Nomploy supports Git-based deployment workflows across providers such as GitHub, GitLab, Bitbucket, and Gitea. Students can move from repository to running app without learning a vendor-specific release process.",
			},
			{
				icon: Layers,
				title: "Support full-stack coursework",
				description:
					"Deploy frontends, APIs, background services, and databases from the same platform. Nomploy supports common databases, including PostgreSQL, MySQL, MongoDB, Redis, and MariaDB.",
			},
			{
				icon: Eye,
			...
			},
			{
				...
				description:
					"Start with a single course sandbox, then expand across labs, bootcamps, research groups, or internal innovation programs. Nomploy supports multi-server management and remote servers, and the platform grows with demand.",
			},
		],
	},
	comparison: {
		...
		description:
			"Giving every student a separate cloud account creates cost, security, and support problems. Nomploy gives institutions a cleaner model: one deployment layer, controlled access, and a familiar developer workflow.",
		without: {
		...
		withNomploy: {
			title: "Nomploy for higher education",
			items: [
	...
	workflow: {
		...
		description:
			"With Nomploy, teaching teams turn deployment into part of the learning journey. Students can go from code to a working URL through a repeatable workflow.",
		steps: [
			{
			...
			},
			{
				...
				description:
					"Students or instructors connect a Git provider and select the relevant branch. Nomploy can trigger deployments through webhooks when changes are pushed.",
			...
			},
			{
				...
				description:
					"Assign a custom or generated domain where students can demo their apps. Nomploy includes domain management through the UI, reducing the need for manual reverse proxy configuration.",
	...
	builtFor: {
		...
		paragraphs: [
			"Nomploy helps institutions offer a modern software delivery experience without pushing infrastructure responsibility onto students.",
			...
			"Administrators can decide whether to use Nomploy Cloud's managed control plane or self-host Nomploy on university-managed infrastructure.",
		],
		screenshotAlt:
			"Nomploy dashboard showing a university course project with separate environments for student sandbox, review, and demo",
	},
	detailRows: [
		{
	...
	faqs: {
		...
		items: [
			{
				question: "Can Nomploy be used as a student sandbox environment?",
				answer:
					"Yes. Nomploy can be used to create controlled environments where students deploy coursework apps without needing direct access to underlying servers. Institutions can structure projects and environments around courses, cohorts, or departments.",
			},
			{
			...
			{
				question: "Does Nomploy support common student project stacks?",
				answer:
					"Yes. Nomploy supports multiple deployment methods, including Git-based apps, Dockerfiles, and Docker Compose. It also supports common databases used in coursework, including PostgreSQL, MySQL, MongoDB, Redis, and MariaDB.",
			},
			{
				question: "Can universities connect Nomploy to existing identity systems?",
				answer:
					"Nomploy Enterprise includes single sign-on options through providers such as Auth0, Keycloak, and other OIDC/SAML providers. That makes it easier to fit Nomploy into existing institutional access workflows.",
			},
			{
				question:
					"Should a university choose Nomploy Cloud or self-hosted Nomploy?",
				answer:
					"Use Nomploy Cloud when you want the Nomploy team to manage the control plane while your apps still run on your own servers. Choose self-hosted when your institution wants to run and maintain the full platform internally.",
			},
		],
	},
};
