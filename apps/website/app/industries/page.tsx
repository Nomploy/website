...
export const metadata: Metadata = {
	...
	description:
		"See how teams in finance, healthcare, government, manufacturing, pharmaceuticals, higher education, and agencies use Nomploy to deploy applications in environments they control.",
	alternates: {
		canonical: "https://nomploy.com/industries",
	},
};
				...
				<Container className="relative z-10">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mt-6 text-lg text-muted-foreground">
							Nomploy gives teams in regulated and fast-moving industries a
