...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://nomploy.com/industries/pharmaceuticals",
	},
};
...
const data: IndustryPageData = {
	...
	features: {
		...
		description:
			"Pharmaceutical teams need to support research, quality, digital operations, and internal tools without letting deployments fragment. Nomploy creates a single deployment workflow that teams can adapt to different applications.",
		items: [
			{
				icon: FlaskConical,
				title: "Deploy lab and research tools privately",
				description:
					"Run internal applications, data tools, dashboards, and service APIs on infrastructure that matches your policy. Choose self-hosted Nomploy or Nomploy Cloud.",
			},
			{
				icon: ScrollText,
	...
	comparison: {
		...
		description:
			"Pharmaceutical technology environments often include research tools, vendor systems, internal apps, and controlled workflows. Nomploy gives teams one platform for releasing and operating software safely.",
		without: {
		...
		withNomploy: {
			title: "Nomploy for pharmaceutical deployment",
			items: [
	...
	workflow: {
		...
		steps: [
			...
			},
			{
				...
				description:
					"Connect a Git repository, Docker image, or Docker Compose file. Nomploy supports flexible build types so each app can use the deployment model that fits its stack.",
	...
	builtFor: {
		...
		paragraphs: [
			"Nomploy gives pharmaceutical organizations a flexible deployment layer for internal software.",
		...
		screenshotAlt:
			"Nomploy dashboard for a pharmaceutical R&D platform with separate production and staging environments and running services",
	},
	detailRows: [
		{
	...
	faqs: {
		...
		items: [
			...
			{
				question: "How does Nomploy support regulated software teams?",
				answer:
					"Nomploy supports controlled deployment workflows with projects, environments, permissions, logs, monitoring, backups, and rollback options. Enterprise features add SSO, custom roles, audit logs, and whitelabeling.",
			},
			{
				question: "Can Nomploy run private pharmaceutical applications?",
				answer:
					"Yes. Nomploy can be self-hosted, or teams can use Nomploy Cloud while deploying applications on their own connected servers. Both models can support internal and private application deployment.",
			},
			{
				question: "Does Nomploy support databases for pharma apps?",
				answer:
					"Yes. Nomploy supports PostgreSQL, MySQL, MongoDB, Redis, and MariaDB, which can be used for internal tools, dashboards, and application services.",
			},
			{
				question: "Should pharmaceutical teams self-host Nomploy?",
				answer:
					"Self-hosting is a good fit when teams need to operate the full platform internally. Nomploy Cloud can be a better fit when teams want a managed control plane while keeping application workloads on their own servers.",
			},
		],
	},
};
