...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://nomploy.com/industries/government",
	},
};
...
const data: IndustryPageData = {
	hero: {
		...
		description:
			"Deploy citizen-facing services, case management systems, and internal department tools without handing infrastructure control to an outside vendor. Nomploy gives teams a self-hosted platform for private deployment and consistent oversight.",
	},
	features: {
		heading:
			"Ship public sector software without losing infrastructure control",
		description:
			"Government agencies need to ship software while keeping data and infrastructure under direct control. With Nomploy, teams release from Git and Docker, while IT manages access and audit trails.",
		items: [
			{
				icon: Server,
	...
	comparison: {
		...
		description:
			"Commercial cloud accounts can become difficult to govern across departments, citizen-facing services, and compliance-sensitive systems. Nomploy centralizes the deployment layer while teams stay productive.",
		without: {
	...
	workflow: {
		...
		description:
			"Nomploy makes release management a clear, repeatable workflow. Developers can ship from their repositories, while IT teams keep the environment, access model, and release path consistent.",
		steps: [
			{
	...
	builtFor: {
		...
		paragraphs: [
			...
			"Nomploy replaces that patchwork with a single deployment layer, so oversight bodies get one consistent audit trail instead of piecing records together from a dozen systems, and smaller departments can ship without waiting on a custom platform build.",
		],
		screenshotAlt:
			"Nomploy dashboard for a government project with production and staging environments and running services",
	},
	detailRows: [
		{
	...
	faqs: {
		...
		items: [
			...
			{
				question: "Can Nomploy run in an air-gapped government environment?",
				answer:
					"Yes. Nomploy Enterprise Self-Hosted can run in air-gapped or private networks, so the application, database, and control plane stay inside infrastructure your agency owns.",
			},
			{
				question:
					"Does Nomploy support SSO and audit logs for government agencies?",
				answer:
					"Yes. Nomploy Enterprise includes SSO via SAML and OIDC, with native integrations for Okta, Azure AD, Auth0, and Keycloak, along with audit logs covering logins, deployments, and configuration changes, and custom RBAC roles.",
			},
			{
				question:
					"Can non-technical staff safely test AI-generated tools with Nomploy?",
				answer:
					"Yes. Nomploy is an application deployment platform that lets teams create sandboxed environments where non-technical staff can deploy and test AI-generated or vibe-coded tools without touching production systems, while IT keeps oversight through audit logs, multitenancy, and access controls.",
			},
			{
				question:
					"Should government agencies choose Nomploy Cloud or self-hosted Nomploy?",
				answer:
					"Use Nomploy Cloud when you want Nomploy to manage the control plane while your agency's applications run on your own servers. Choose self-hosted Nomploy, including air-gapped installs, when your agency needs to operate the full platform entirely within its own network.",
			},
		],
	},
};
