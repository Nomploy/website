...
export const metadata: Metadata = {
	title: "Partners",
	description:
		"Join the Nomploy partner program. Agency plan, referral program, and reseller options.",
};
...
const PROGRAMS = [
	...
	},
	{
		...
		badgeVariant: "default" as const,
		description:
			"Earn 20% commission on every customer you refer to Nomploy.",
		features: [
	...
	},
	{
		...
		description:
			"Sell Nomploy directly in your market with local presence and relationships.",
		features: [
				...
				<Container>
					<div className="mx-auto max-w-2xl">
						...
						<p className="mt-3 text-center text-muted-foreground">
							Join our partner program and start growing with Nomploy.
						</p>
